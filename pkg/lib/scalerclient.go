...
type scaleClient struct {
	mapper scale.PreferredResourceMapper
...
func NewForConfig(cfg *restclient.Config, mapper scale.PreferredResourceMapper, resolver dynamic.APIPathResolverFunc, scaleKindResolver scale.ScaleKindResolver) (scale.ScalesGetter, error) {
...
func New(baseClient restclient.Interface, mapper scale.PreferredResourceMapper, resolver dynamic.APIPathResolverFunc, scaleKindResolver scale.ScaleKindResolver) scale.ScalesGetter {
	return &scaleClient{
		mapper: mapper,
...
func (c *scaleClient) Scales(namespace string) scale.ScaleInterface {
