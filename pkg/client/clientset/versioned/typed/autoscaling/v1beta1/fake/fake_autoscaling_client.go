...
func (c *FakeAutoscalingV1beta1) CronHorizontalPodAutoscalers(namespace string) v1beta1.CronHorizontalPodAutoscalerInterface {
	return &FakeCronHorizontalPodAutoscalers{c, namespace}
}
